...
<?php
  ...
  {
    $message = "You are already logged in, you do not need this page";
...
<link rel="stylesheet" href="../../includes/resetPassword.css"/>
<script>
...
function resetFunc(ev)
{
  ...
  ajax.open("POST", "../../scripts/resetMailingScript.php");
  ajax.send(formdata);
...
<div id="container">
  <div class="center">
      ...
      <form id="resetForm" method="post" onsubmit="return resetFunc(event)" enctype="multipart/form-data">
        <div id="resetContainer">
          <fieldset>
            <legend>Forgot Password</legend>
            <div id="blurb">
              Upon completion of this form, you will be sent an email with a link to reset your password.
            </div>
            <div id="section1">
              <label id="emailBoxlbl" for="emailBox">Enter your email</label>
              <input id="emailBox" type="email" name="emailBox" placeholder="Email" required>
            </div>
            <div id="buttonArea">
              <input id="emailSubmit" type="submit" value="Send Email">
            </div>
          </fieldset>
        </div>
      </form>
