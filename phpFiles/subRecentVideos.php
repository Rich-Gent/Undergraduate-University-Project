...
<?php
  ...
  $videoInfo = array();
  $stmt = $mysqli->prepare("SELECT UserID, VideoID, VName, Thumbnail, Views, Banned FROM Videos  WHERE UserID = ? ORDER BY UploadTD DESC");
...
<div id="container">
  <div class="center">
      ...
      <div class="vidThumbnails">
        <h2><?php echo $uploaderUsername; ?>'s Recenlty Uploaded videos</h2>
      <?php
      if(!isset($video))
      {
        echo "<div id='thumbMessage'>Video uploads are empty. This user has not uploaded videos yet</div>";
      }
      else
      {
