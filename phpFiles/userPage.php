...
<?php
  ...
  $uploaderUserID = $_SESSION['userID'];
  $stmt = $mysqli->prepare("SELECT VideoID, VName, Thumbnail, Views, Banned FROM Videos WHERE UserID = ? ORDER BY UploadTD DESC");
  ...
  $stmt = $mysqli->prepare("SELECT AccessLevel, Username, UserImage, BannerImage FROM Users WHERE UserID = ?");
  $stmt->bind_param("i", $uploaderUserID);
  $stmt->execute();
  $stmt->store_result();
  $stmt->bind_result($accessLevel, $uploaderUsername, $uploaderThumbnail, $uploaderBanner);
  $stmt->fetch();
  $stmt->close();
...
<link rel="stylesheet" href="../../includes/UserPage.css"/>
<script>
...
<div id="container">
  <div class="center">
      ...
      <div class="UserHeader">
        ...
        <div class="nav">
          <span id="HUsername"><?php echo $username; ?></span>
          <span id="HSubscribe"></span>
          <div id="links">
            <a href="../uSettings/?uID=<?php echo $uploaderUserID; ?>" id="Settings">Settings</a>
            <a href="../historyPage" id="history">History</a>
            <a href="../favouritesPage" id="favourites">Favourite Videos</a>
            <a href="../uploadPage" id="UploadVideo">Upload Video</a>
        ...
        else
        {
          foreach($data as $val)
          {
            if($val->banned == 1)
            {
              ...
              echo "<b style='color: red; display:block; margin-top: 50px;'>THIS VIDEO HAS BEEN BANNED</b>\n
            ...
            else
            {
             ...
             echo  "'> \n";
              echo  "<img alt='VideoImage' id='videoImage' src=" . $val->vThumbnail  . "> \n
                    <div class='videoInfo'> <b>".  $val->vName ." </b> </div>\n
                    <div class='views'>Views:<b>" . $val->views . "</b> </div> \n
                    </div>\n";
            }
